...
import { validateInvite, activateChildAccount, childSignIn, childSignOut, refreshChildToken, getMyStrictRules, updateProfile } from "../controllers/childAuthController.js";
...
router.patch('/profile', requireAuth, requireChild, uploadAvatar.single('avatar'), updateProfile)
