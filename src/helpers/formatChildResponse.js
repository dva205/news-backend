export const formatChildResponse = (child, invite = null, strict = null) => {
    ...
    const inviteData = invite || (child.receivedInvites && child.receivedInvites[0]) || null;
    ...
    return {
        ...
        invite: {
            ...
            isExpired: inviteData?.expires_at ? new Date(inviteData.expires_at) < new Date() : false,
        }
    };
};