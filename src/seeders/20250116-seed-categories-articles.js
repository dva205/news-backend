    ...
    const articles = [
      {
        ...
        content: 'Piano là một nhạc cụ tuyệt vời để bắt đầu học nhạc. Trẻ em có thể phát triển khả năng tư duy và sáng tạo thông qua âm nhạc.',
      ...
      },
      {
        ...
        content: 'Bóng đá giúp trẻ phát triển thể chất, học cách làm việc nhóm và rèn luyện tinh thần đồng đội.',
      ...
      },
      {
        ...
        content: 'Học toán không khó nếu bạn biết cách làm cho nó thú vị. Hãy cùng khám phá các trò chơi toán học.',
      ...
      },
      {
        ...
        content: 'Hệ mặt trời có 8 hành tinh. Sao Thủy gần mặt trời nhất, sao Hải Vương xa nhất.',
      ...
      },
      {
        ...
        content: 'Những bộ phim hoạt hình giáo dục và vui nhộn phù hợp cho trẻ em.',
      ...
      },
      {
        ...
        content: 'Những câu chuyện đáng sợ về ma quỷ và bạo lực. Không phù hợp cho trẻ nhỏ.',
      ...
      },
      {
        ...
        content: 'Các vấn đề xã hội liên quan đến bạo lực và ma túy. Nội dung dành cho người lớn.',
      ...
      },
      {
        ...
        content: 'Bơi lội giúp trẻ phát triển toàn diện cơ thể, tăng cường sức khỏe.',
        category_id: categoryMap['Thể thao'],
      ...
      },
      {
        ...
        content: 'Học tiếng Anh thông qua các bài hát vui nhộn giúp trẻ tiếp thu nhanh hơn.',
        category_id: categoryMap['Giáo dục'],
